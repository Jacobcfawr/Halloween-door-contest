...
<html>
  ...
  <body>
    ...
    <center>
      <div class="texty" style="font-size: 20px" id="var">current W.A.'s: 0</div>
      <br />

      <img class="box" src="WA-Criswell.jpeg" alt="" onclick="myfunction()"> </img>
    </center>
    <h1 style="font-size: 30px">Reach 1,000 W.A.'s for Candy</h1>
